...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField] Image basisImage;
        ...
        public void RecenterVR()
        {
            ...
            {
                Debug.Log("Reset VRSettings.loadedDeviceName == Oculus");
                UnityEngine.VR.InputTracking.Recenter();
            }

            if (VRSettings.loadedDeviceName == "OpenVR")
            {
                Debug.Log("Reset VRSettings.loadedDeviceName == OpenVR");
        ...
        private void EyeRaycast()
        {
            ...
            if (Physics.Raycast(ray, out hit, m_RayLength, ~m_ExclusionLayers))
            {
                ...
                if (asItem == interactible && hit.collider.GetComponent<VRInteractiveItem>())
                {
                    basisImage.gameObject.SetActive(false);
                    image.gameObject.SetActive(true);

                    image.fillAmount = timer / interactible.waitTime;
                ...
                else
                {
                    ...
                    basisImage.gameObject.SetActive(true);
